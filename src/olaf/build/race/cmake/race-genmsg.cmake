...
set(MSG_I_FLAGS "-Irace:/home/nvidia/olaf/src/race/msg;-Istd_msgs:/opt/ros/kinetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/nvidia/olaf/src/race/msg/drive_values.msg" NAME_WE)
add_custom_target(_race_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "race" "/home/nvidia/olaf/src/race/msg/drive_values.msg" ""
)

get_filename_component(_filename "/home/nvidia/olaf/src/race/msg/lane_info.msg" NAME_WE)
add_custom_target(_race_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "race" "/home/nvidia/olaf/src/race/msg/lane_info.msg" ""
)

get_filename_component(_filename "/home/nvidia/olaf/src/race/msg/enc_values.msg" NAME_WE)
add_custom_target(_race_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "race" "/home/nvidia/olaf/src/race/msg/enc_values.msg" ""
)

get_filename_component(_filename "/home/nvidia/olaf/src/race/msg/mode.msg" NAME_WE)
add_custom_target(_race_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "race" "/home/nvidia/olaf/src/race/msg/mode.msg" ""
)

get_filename_component(_filename "/home/nvidia/olaf/src/race/msg/test.msg" NAME_WE)
add_custom_target(_race_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "race" "/home/nvidia/olaf/src/race/msg/test.msg" ""
)
