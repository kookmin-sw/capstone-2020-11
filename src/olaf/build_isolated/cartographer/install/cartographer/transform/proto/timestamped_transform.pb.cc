...
void TableStruct::InitDefaultsImpl() {
  ...
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_TimestampedTransform_default_instance_);_TimestampedTransform_default_instance_._instance.get_mutable()->transform_ = const_cast< ::cartographer::transform::proto::Rigid3d*>(
