...
class LegacySerializedDataLegacySubmap : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:cartographer.mapping.proto.LegacySerializedDataLegacySubmap) */ {
 public:
  ...
  inline LegacySerializedDataLegacySubmap* New() const PROTOBUF_FINAL { return New(NULL); }

  LegacySerializedDataLegacySubmap* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
...
inline void LegacySerializedDataLegacySubmap::clear_submap() {
  if (GetArenaNoVirtual() == NULL && submap_ != NULL) delete submap_;
  submap_ = NULL;
}
...
inline void LegacySerializedDataLegacySubmap::clear_node() {
  if (GetArenaNoVirtual() == NULL && node_ != NULL) delete node_;
  node_ = NULL;
}
...
inline void LegacySerializedDataLegacySubmap::clear_imu_data() {
  if (GetArenaNoVirtual() == NULL && imu_data_ != NULL) delete imu_data_;
  imu_data_ = NULL;
}
...
inline void LegacySerializedDataLegacySubmap::clear_odometry_data() {
  if (GetArenaNoVirtual() == NULL && odometry_data_ != NULL) delete odometry_data_;
  odometry_data_ = NULL;
}
...
inline void LegacySerializedDataLegacySubmap::clear_fixed_frame_pose_data() {
  if (GetArenaNoVirtual() == NULL && fixed_frame_pose_data_ != NULL) delete fixed_frame_pose_data_;
  fixed_frame_pose_data_ = NULL;
}
...
inline void LegacySerializedDataLegacySubmap::clear_trajectory_data() {
  if (GetArenaNoVirtual() == NULL && trajectory_data_ != NULL) delete trajectory_data_;
  trajectory_data_ = NULL;
}
...
inline void LegacySerializedDataLegacySubmap::clear_landmark_data() {
  if (GetArenaNoVirtual() == NULL && landmark_data_ != NULL) delete landmark_data_;
  landmark_data_ = NULL;
}
