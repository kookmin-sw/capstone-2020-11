...
void TableStruct::InitDefaultsImpl() {
  ...
  _PoseGraphOptions_default_instance_._instance.get_mutable()->overlapping_submaps_trimmer_2d_ = const_cast< ::cartographer::mapping::proto::PoseGraphOptions_OverlappingSubmapsTrimmerOptions2D*>(
