...
echo_and_run /usr/bin/env \
    PYTHONPATH="/home/nvidia/olaf/install_isolated/lib/python2.7/dist-packages:/home/nvidia/olaf/build_isolated/rosserial_vex_cortex/lib/python2.7/dist-packages:$PYTHONPATH" \
    CATKIN_BINARY_DIR="/home/nvidia/olaf/build_isolated/rosserial_vex_cortex" \
    "/usr/bin/python2" \
    "/home/nvidia/olaf/src/rosserial/rosserial_vex_cortex/setup.py" \
    build --build-base "/home/nvidia/olaf/build_isolated/rosserial_vex_cortex" \
    install \
    $DESTDIR_ARG \
