...
if("TRUE" STREQUAL "TRUE")
  set(rosserial_xbee_SOURCE_PREFIX /home/nvidia/olaf/src/rosserial/rosserial_xbee)
  set(rosserial_xbee_DEVEL_PREFIX /home/nvidia/olaf/devel_isolated/rosserial_xbee)
  ...
  set(rosserial_xbee_INSTALL_PREFIX /home/nvidia/olaf/install_isolated)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosserial_xbee' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nvidia/olaf/src/rosserial/rosserial_xbee/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/nvidia/olaf/devel_isolated/rosserial_xbee/lib;/home/nvidia/olaf/install_isolated/lib;/home/nvidia/olaf/devel/lib;/opt/ros/kinetic/lib)
