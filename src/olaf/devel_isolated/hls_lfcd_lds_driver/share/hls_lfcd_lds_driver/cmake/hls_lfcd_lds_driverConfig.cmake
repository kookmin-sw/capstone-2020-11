...
if("TRUE" STREQUAL "TRUE")
  set(hls_lfcd_lds_driver_SOURCE_PREFIX /home/nvidia/olaf/src/hls_lfcd_lds_driver)
  set(hls_lfcd_lds_driver_DEVEL_PREFIX /home/nvidia/olaf/devel_isolated/hls_lfcd_lds_driver)
  ...
  set(hls_lfcd_lds_driver_INSTALL_PREFIX /home/nvidia/olaf/install_isolated)
...
if(NOT "/home/nvidia/olaf/src/hls_lfcd_lds_driver/include;/usr/include " STREQUAL " ")
  set(hls_lfcd_lds_driver_INCLUDE_DIRS "")
  set(_include_dirs "/home/nvidia/olaf/src/hls_lfcd_lds_driver/include;/usr/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'hls_lfcd_lds_driver' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nvidia/olaf/src/hls_lfcd_lds_driver/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/nvidia/olaf/devel_isolated/hls_lfcd_lds_driver/lib;/home/nvidia/olaf/install_isolated/lib;/home/nvidia/olaf/devel/lib;/opt/ros/kinetic/lib)
