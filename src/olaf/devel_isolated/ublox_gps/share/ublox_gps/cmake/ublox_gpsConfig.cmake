...
if("TRUE" STREQUAL "TRUE")
  set(ublox_gps_SOURCE_PREFIX /home/nvidia/olaf/src/ublox/ublox_gps)
  set(ublox_gps_DEVEL_PREFIX /home/nvidia/olaf/devel_isolated/ublox_gps)
  ...
  set(ublox_gps_INSTALL_PREFIX /home/nvidia/olaf/install_isolated)
...
if(NOT "/home/nvidia/olaf/src/ublox/ublox_gps/include " STREQUAL " ")
  set(ublox_gps_INCLUDE_DIRS "")
  set(_include_dirs "/home/nvidia/olaf/src/ublox/ublox_gps/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ublox_gps' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nvidia/olaf/src/ublox/ublox_gps/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/nvidia/olaf/devel_isolated/ublox_gps/lib;/home/nvidia/olaf/install_isolated/lib;/home/nvidia/olaf/devel/lib;/opt/ros/kinetic/lib)
