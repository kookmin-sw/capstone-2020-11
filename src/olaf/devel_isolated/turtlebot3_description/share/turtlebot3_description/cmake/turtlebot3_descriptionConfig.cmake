...
if("TRUE" STREQUAL "TRUE")
  set(turtlebot3_description_SOURCE_PREFIX /home/nvidia/olaf/src/turtlebot3/turtlebot3_description)
  set(turtlebot3_description_DEVEL_PREFIX /home/nvidia/olaf/devel_isolated/turtlebot3_description)
  ...
  set(turtlebot3_description_INSTALL_PREFIX /home/nvidia/olaf/install_isolated)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'turtlebot3_description' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nvidia/olaf/src/turtlebot3/turtlebot3_description/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/nvidia/olaf/devel_isolated/turtlebot3_description/lib;/home/nvidia/olaf/install_isolated/lib;/home/nvidia/olaf/devel/lib;/opt/ros/kinetic/lib)
