...
if("TRUE" STREQUAL "TRUE")
  set(rosserial_windows_SOURCE_PREFIX /home/nvidia/olaf/src/rosserial/rosserial_windows)
  set(rosserial_windows_DEVEL_PREFIX /home/nvidia/olaf/devel_isolated/rosserial_windows)
  ...
  set(rosserial_windows_INSTALL_PREFIX /home/nvidia/olaf/install_isolated)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosserial_windows' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nvidia/olaf/src/rosserial/rosserial_windows/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/nvidia/olaf/devel_isolated/rosserial_windows/lib;/home/nvidia/olaf/install_isolated/lib;/home/nvidia/olaf/devel/lib;/opt/ros/kinetic/lib)
