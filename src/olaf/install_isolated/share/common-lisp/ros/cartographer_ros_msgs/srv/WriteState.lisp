...
(cl:defclass <WriteState-request> (roslisp-msg-protocol:ros-message)
  ((filename
   ...
   (include_unfinished_submaps
    :reader include_unfinished_submaps
...
(cl:ensure-generic-function 'include_unfinished_submaps-val :lambda-list '(m))
(cl:defmethod include_unfinished_submaps-val ((m <WriteState-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cartographer_ros_msgs-srv:include_unfinished_submaps-val is deprecated.  Use cartographer_ros_msgs-srv:include_unfinished_submaps instead.")
  (include_unfinished_submaps m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <WriteState-request>) ostream)
  ...
  (cl:write-byte (cl:ldb (cl:byte 8 0) (cl:if (cl:slot-value msg 'include_unfinished_submaps) 1 0)) ostream)
)
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <WriteState-request>) istream)
  "Deserializes a message object of type '<WriteState-request>"
    ...
    (cl:setf (cl:slot-value msg 'include_unfinished_submaps) (cl:not (cl:zerop (cl:read-byte istream))))
  msg
)
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<WriteState-request>)))
  ...
  "96db93844e1eb87ed5b1526b3e48e3bb")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'WriteState-request)))
  "Returns md5sum for a message object of type 'WriteState-request"
  "96db93844e1eb87ed5b1526b3e48e3bb")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<WriteState-request>)))
  ...
  (cl:format cl:nil "~%~%~%~%~%~%~%~%~%~%~%~%~%~%string filename~%bool include_unfinished_submaps~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'WriteState-request)))
  "Returns full string definition for message of type 'WriteState-request"
  (cl:format cl:nil "~%~%~%~%~%~%~%~%~%~%~%~%~%~%string filename~%bool include_unfinished_submaps~%~%~%"))
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <WriteState-request>))
  ...
  (cl:list 'WriteState-request
    ...
    (cl:cons ':include_unfinished_submaps (include_unfinished_submaps msg))
))
