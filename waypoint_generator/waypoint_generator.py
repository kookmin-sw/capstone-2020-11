...
tmp = {'idx' : 0, 'name' : 'START_POINT', 'x_location' : 0, 'y_location' : 0, 'yaw': 0, 'lds_detect' : 'LEFT', 'line_detect' : 'ON', "drive" : "FOWARD", "is_intersact": 0}
tmp1 = {'idx' : 1, 'name' : '608', 'x_location' : 2, 'y_location' : 0, 'yaw': 0, 'lds_detect' : 'LEFT', 'line_detect' : 'ON', "drive" : "FOWARD", "is_intersact": 0}
tmp2 = {'idx' : 2, 'name' : 'OFFICE', 'x_location' : 4, 'y_location' : 0, 'yaw': 0, 'lds_detect' : 'FRONT', 'line_detect' : 'OFF', "drive" : "ROTATION", "is_intersact": 1}
tmp3 = {'idx' : 3, 'name' : '630', 'x_location' : 4, 'y_location' : -2, 'yaw': -90, 'lds_detect' : 'LEFT', 'line_detect' : 'ON', "drive" : "FRONT", "is_intersact": 1}
...
with open('way_point.json','w',encoding='utf-8') as make_file:
    json.dump(way_point,make_file,ensure_ascii=False, indent="\t")
